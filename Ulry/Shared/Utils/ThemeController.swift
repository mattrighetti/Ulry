...
class ThemeController: NSObject {
    ...
    init(defaults: UserDefaults = .standard) {
        ...
        super.init()
        self.defaults.addObserver(self, forKeyPath: Defaults.theme.rawValue, options: [.old, .new], context: nil)
    }
    ...
    deinit {
        UserDefaults.standard.removeObserver(self, forKeyPath: Defaults.theme.rawValue, context: nil)
    }
}
