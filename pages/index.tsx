...
const Home: NextPage = () => {
    return (
        <>
            ...
            <Feature img="/images/add-group.png" title="Highly customisable" body="Everything that you see in Ulry is under your control, you can change group icons and colors, same goes for tags." odd={false} />
            <Feature img="/images/redirector.png" title="Redirections" body="Are you tired of paywalled articles or websites that require you to sign in? Ulry got you covered! With redirections you can tell Ulry which websites you would like to be redirected to for specific websites" odd={true} />
            <Footer />
        </>
    )
}
